...
// TODO: Уточнить статус для удаленных проектов
// Пока используется ARCHIVED, возможно нужен отдельный статус DELETED
        ...
        {isError && (
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <p className="text-danger-500 mb-2">
                Ошибка загрузки удаленных проектов
              </p>
        ...
        {!isLoading && !isError && data?.projects && (
          <>
            {data.projects.length === 0 ? (
              <div className="flex items-center justify-center h-64">
                <p className="text-default-500">Удаленных проектов нет</p>
              </div>
            ) : (
              <>
                {/* Заголовки столбцов */}
